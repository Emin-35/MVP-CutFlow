...
def require_accounting(current_user: User = Depends(get_current_user)) -> User:
    # 🚀 Sürdürülebilirlik İyileştirmesi: Müdür otomatik olarak muhasebe yetkilerine de sahip olsun
    if current_user.role not in [UserRole.accounting, UserRole.manager]:
